  ...
  const sections = [
    {
      ...
      content: "This layout showcases responsive design patterns using Tailwind CSS utility classes. Notice how the layout changes based on screen size."
    },
    {
      title: "Mobile First",
      content: "We start with a mobile design and progressively enhance the experience for larger screens. This approach ensures a good experience on all devices."
    },
    {
      title: "Flexible Grid",
      content: "The grid system adapts based on available space, changing from a single column on mobile to multiple columns on larger screens."
    }
  ];
          ...
          <div className="stack-to-row justify-between items-center">
            ...
            <nav className="w-full sm:w-auto">
              <ul className="stack-to-row space-y-2 sm:space-y-0 sm:space-x-6">
                ...
                <li className="hide-on-mobile"><a href="#" className="hover:underline">Contact</a></li>
              </ul>
            </nav>
          </div>
        </div>
      ...
      <main className="container-custom py-8">
            ...
            <div className="stack-to-row items-center">
              <div className="half-on-tablet mb-6 sm:mb-0">
                ...
                <p className="text-center-left-on-tablet paragraph mb-6">
                  This page demonstrates various responsive design patterns 
                  implemented with Tailwind CSS utility classes.
                </p>
        ...
        <section className="responsive-padding bg-[var(--color-vulcan-200)] rounded-lg">
          ...
          <p className="paragraph mb-4">
            Notice how the padding and margins adjust based on screen size.
            This section uses responsive padding that increases on larger screens.
          </p>
          ...
          <div className="grid-cols-2 responsive-gap">
            <div>
              ...
              <p className="text-[var(--color-vulcan-300)] mb-4">
                This demo showcases responsive layout techniques using 
                Tailwind CSS utility classes and custom responsive utilities.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-bold mb-4">Quick Links</h3>
              <ul className="space-y-2">
                <li><a href="/" className="text-[var(--color-vulcan-300)] hover:text-white">Home</a></li>
                <li><a href="#" className="text-[var(--color-vulcan-300)] hover:text-white">Features</a></li>
                <li><a href="#" className="text-[var(--color-vulcan-300)] hover:text-white">Documentation</a></li>
                <li><a href="#" className="text-[var(--color-vulcan-300)] hover:text-white">Contact</a></li>
              </ul>
            </div>
          </div>
