  ...
  return (
    <div className="min-h-screen bg-[var(--color-vulcan-50)]">
          ...
          <div className="hidden md:flex items-center relative max-w-md w-full mx-4">
            <div className="relative w-full">
              ...
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="w-4 h-4 absolute left-3 top-1/2 transform -translate-y-1/2 text-[var(--color-vulcan-400)]"
              >
                <circle cx="11" cy="11" r="8"></circle>
                <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
              </svg>
            </div>
            <div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[var(--color-vulcan-400)] text-xs">
              ⌘K
            </div>
          </div>
        ...
        <div className="container-custom">
          ...
          <div className="bg-white border border-[var(--color-vulcan-200)] rounded-lg p-6 max-w-4xl mx-auto shadow-lg dark:bg-[var(--color-vulcan-100)]">
            <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
              <div className="p-4 rounded bg-[var(--color-vulcan-100)] text-center text-sm font-medium">
                vulcan-100
              </div>
              <div className="p-4 rounded bg-[var(--color-vulcan-200)] text-center text-sm font-medium">
                vulcan-200
              </div>
              <div className="p-4 rounded bg-[var(--color-vulcan-300)] text-center text-sm font-medium">
                vulcan-300
              </div>
              <div className="p-4 rounded bg-[var(--color-vulcan-400)] text-white text-center text-sm font-medium">
                vulcan-400
              </div>
              <div className="p-4 rounded bg-[var(--color-vulcan-500)] text-white text-center text-sm font-medium">
                vulcan-500
              </div>
              <div className="p-4 rounded bg-[var(--color-vulcan-600)] text-white text-center text-sm font-medium">
                vulcan-600
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <h3 className="text-xl font-bold mb-2 text-[var(--color-vulcan-800)]">
                Responsive Layouts
              </h3>
              <p className="text-[var(--color-vulcan-600)]">
                Pre-built responsive components that look great on any device
              </p>
            </div>
            ...
            <div className="card p-6">
              ...
              <p className="text-[var(--color-vulcan-600)]">
                Tailwind CSS v4 with custom theme variables and utilities
              </p>
            </div>
            ...
            <div className="card p-6">
              ...
              <p className="text-[var(--color-vulcan-600)]">
                Authentication, cards, layouts and more - ready for your next project
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-[var(--color-vulcan-800)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="/login" className="card p-6 hover:shadow-lg transition-all">
              <h3 className="text-lg font-semibold mb-2 text-[var(--color-vulcan-800)]">
                Authentication
              </h3>
              <p className="text-sm text-[var(--color-vulcan-600)]">
                Pre-built login and authentication components
              </p>
            </a>
            ...
            <a href="/responsive-cards" className="card p-6 hover:shadow-lg transition-all">
              ...
              <p className="text-sm text-[var(--color-vulcan-600)]">
                Card components that adapt to any screen size
              </p>
            </a>
            ...
            <a href="/tailwind-apply" className="card p-6 hover:shadow-lg transition-all">
              ...
              <p className="text-sm text-[var(--color-vulcan-600)]">
                Examples of using Tailwind's @apply directive
              </p>
            </a>
            ...
            <a href="/vulcan-theme" className="card p-6 hover:shadow-lg transition-all">
              ...
              <p className="text-sm text-[var(--color-vulcan-600)]">
                Explore the Vulcan color palette and components
              </p>
            </a>
      ...
      <footer className="py-10 border-t border-[var(--color-vulcan-200)]">
        <div className="container-custom text-center text-[var(--color-vulcan-600)]">
          ...
          <p className="text-sm mt-2">
            Built with React, Tailwind CSS v4, and modern best practices.
          </p>
        </div>
      </footer>
    </div>
          ...
          <div className="max-w-md mx-auto">
            <div className="divide-y divide-[var(--color-vulcan-200)]">
              <div className="py-8 text-base leading-6 space-y-4 text-[var(--color-vulcan-700)] sm:text-lg sm:leading-7">
                <h1 className="text-3xl font-bold mb-4 text-[var(--color-vulcan-800)]">
                  About Page
                </h1>
